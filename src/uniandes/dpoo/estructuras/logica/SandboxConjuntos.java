...
public class SandboxConjuntos
{
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena ){
        ...
        arbolCadenas.remove(cadenaMinusculas);
        arbolCadenas.remove(cadenaMayusculas);
    }
    /**
    ...
    public void volverMayusculas( ){
        if (!arbolCadenas.isEmpty()) { 
            NavigableSet<String> arbolCadenasMayusculas = new TreeSet<>();
            String[] cadenas = arbolCadenas.toArray(new String[arbolCadenas.size()]);
            for (int i = 0; i < cadenas.length; i++) {
                arbolCadenasMayusculas.add(cadenas[i].toUpperCase());
            }
            arbolCadenas.clear();
            arbolCadenas.addAll(arbolCadenasMayusculas);
        }
    }
    ...
    public TreeSet<String> invertirCadenas( ){
        TreeSet<String> arbolCadenasInvertido = new TreeSet<>(java.util.Collections.reverseOrder());
        arbolCadenasInvertido.addAll(arbolCadenas);
        return arbolCadenasInvertido;
    }
    ...
    public boolean compararElementos( String[] otroArreglo ){
    	 TreeSet<String> conjuntico = new TreeSet<>();
         for (String cadena : otroArreglo) {
             conjuntico.add(cadena);
         }
         return arbolCadenas.containsAll(conjuntico);
    	}
}
